...
- [x] Updated _config.yml: version 0.9.0-beta (2026-03-03)
...
- [x] Already migrated: telar-content/objects/
- [x] Already migrated: telar-content/spreadsheets/
- [x] Already migrated: telar-content/texts/
...
- [x] Added columns to tu-historia.csv: página
- [x] Added columns to your-story.csv: page
- [x] No broken path references found in user content
